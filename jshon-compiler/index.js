...
//var staticDir = path.join(srcDir,"/statics");
//var staticDirs = fs.readdirSync(staticDir,"utf8");

//Serve statics
// var staticServers = {};
// for(var i=0;i<staticDirs.length;i++){
//     staticServers[path.join("/statics/",staticDirs[i])]
//     = serveStatic(path.join(staticDir,"/",staticDirs[i]),{
//         cacheControl:false,
//         etag:false,
//         index:false
//     })
