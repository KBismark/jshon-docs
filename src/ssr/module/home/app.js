...
`.replace(/    /gs,"  ")
            ...
            return (
                function htmlString(args){return (`<div>${JSHON.getRightValue(render(this.state.components.togglebody,false))}${JSHON.getRightValue(render(this.state.components.topnav))}<div id="frontage" class=" jsh-w"><div class=" jsh-x"><h2>JavaScript-HTML Object Notation</h2></div><h3 class=" jsh-y jsh-z jsh-A"> Reactivity with <span class=" jsh-B">Possibilities</span></h3><div class=" jsh-g jsh-h jsh-A"><span key="prev" title="Show previous slide" tabindex="0" role="button"${JSHON.getDynamicAttributes(this,"prev","ti ti-player-track-prev white-border-on-hover jsh-C jsh-D jsh-E jsh-F")}></span><span key="control" title="Pause presentation" tabindex="0" role="button"${JSHON.getDynamicAttributes(this,"control","ti ti-player-pause white-border-on-hover jsh-C jsh-D jsh-E jsh-F jsh-G")}></span><span key="next" title="Show next slide" tabindex="0" role="button"${JSHON.getDynamicAttributes(this,"next","ti ti-player-track-next white-border-on-hover jsh-C jsh-D jsh-E jsh-F")}></span></div></div>${JSHON.getRightValue(render(this.state.components.showcase,this.state.showcaseEditors[this.state.nextEditor].editors.map((e,i)=>{
                            return render(e,{
