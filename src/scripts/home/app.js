...
`.replace(/    /gs,"  ")
            ...
            return (
                <jshon>
                    <div>
                        <>{render(this.state.components.togglebody,false)}</>
                        <>{render(this.state.components.topnav)}</>
                        <div id="frontage" style="text-align: center;">
                            <div style="background-color: #e0ffff;">
                                <h2>JavaScript-HTML Object Notation</h2>
                            </div>
                            <h3 style="color:#fff;margin-top:20px;margin-bottom:20px" class=""> Reactivity with <span style="color: #a90345;">Possibilities</span> </h3>
                            <div style="display: flex;justify-content: center;margin-bottom:20px">
                                <span key="prev" title="Show previous slide" tabindex="0" role="button" class="ti ti-player-track-prev white-border-on-hover" style="background-color: #000;border-radius:5px;padding: 4px 5.5px;cursor: pointer;"></span>
                                <span key="control" title="Pause presentation" tabindex="0" role="button" class="ti ti-player-pause white-border-on-hover" style="background-color: #000;border-radius:5px;padding: 4px 5.5px;cursor: pointer;margin:0px 5px"></span>
                                <span key="next" title="Show next slide" tabindex="0" role="button" class="ti ti-player-track-next white-border-on-hover" style="background-color: #000;border-radius:5px;padding: 4px 5.5px;cursor: pointer;"></span>
                            </div>
                        </div>
                        <>{render(this.state.components.showcase,this.state.showcaseEditors[this.state.nextEditor].editors.map((e,i)=>{
                            return render(e,{
