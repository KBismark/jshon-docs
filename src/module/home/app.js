...
`.replace(/    /gs,"  ")
            ...
            return (
                {t:'div',a:{},c:[function(args){return (render(this.state.components.togglebody,false))},function(args){return (render(this.state.components.topnav))},{t:'div',a:{"id":"frontage","class":" jsh-w"},c:[{t:'div',a:{"class":" jsh-x"},c:[{t:'h2',a:{},c:["JavaScript-HTML Object Notation"]}]},{t:'h3',a:{"class":" jsh-E jsh-O jsh-Y"},c:[" Reactivity with ",{t:'span',a:{"class":" jsh-z"},c:["Possibilities"]}]},{t:'div',a:{"class":" jsh-g jsh-h jsh-Y"},c:[{t:'span',a:{"key":"prev","title":"Show previous slide","tabindex":"0","role":"button","class":"ti ti-player-track-prev white-border-on-hover jsh-K jsh-Z jsh-L jsh-M"},c:[]},{t:'span',a:{"key":"control","title":"Pause presentation","tabindex":"0","role":"button","class":"ti ti-player-pause white-border-on-hover jsh-K jsh-Z jsh-L jsh-M jsh-0"},c:[]},{t:'span',a:{"key":"next","title":"Show next slide","tabindex":"0","role":"button","class":"ti ti-player-track-next white-border-on-hover jsh-K jsh-Z jsh-L jsh-M"},c:[]}]}]},function(args){return (render(this.state.components.showcase,this.state.showcaseEditors[this.state.nextEditor].editors.map((e,i)=>{
                            return render(e,{
