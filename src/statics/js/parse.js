function Parser(themenum,transparent){
    ...
    function theme(){
        Theme={str:"rgb(179, 66, 37)",cm:"rgb(85, 179, 85)",bg:!transparent?"#03111b":"transparent",k1:"#1168cc",k2:"#80468f",k3:"#85d6eb",k4:"rgb(238, 225, 151)",sp:"rgb(218, 209, 209)",n:"rgb(143, 226, 185)"};
        switch (themenum) {
            case 1:
                Theme={str:"#de5926",cm:"gray",bg:!transparent?"#100d25":"transparent",k1:"#14abf3",k2:"#fd0ab2",k3:"#07ffff",k4:"#f1d433",sp:"gray",n:"white"};
                break;
            case 2:
                Theme={str:"#b3572ad1",cm:"#e81111",bg:!transparent?"#03111b":"transparent",k1:"#a5533a",k2:"#80468f",k3:"",k4:"rgb(218, 209, 209)",sp:"rgb(218, 209, 209)",n:"rgb(143, 226, 185)"};
                break;
            case 4:
                //inline #9dad6e
    ...
    function toEditor(obj,s,lang,inline){
        ...
        var htmlTags = ["script","html","i","head","meta","body","style","p","div","title","link","h1","jshon","span"],htmlCpart=[],hts;
